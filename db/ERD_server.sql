...
DROP TABLE IF EXISTS FILTER_SUB;
...
CREATE TABLE FILTER_SUB
(
	FILTER_ID int NOT NULL,
	FILTER_SUB_ID int NOT NULL,
	FILTER_SUB_NM varchar(64),
	VALUE varchar(64),
	PRIMARY KEY (FILTER_ID, FILTER_SUB_ID)
);
...
(
	...
	PRIORITY int,
	VALUE varchar(64),
	PRIMARY KEY (FILTER_ID, USER_TOKEN)
);
